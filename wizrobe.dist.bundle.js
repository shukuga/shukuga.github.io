var wizrobe = function(t) {
    ...
    class l extends s.a {
        ...
        constructor(t = null) {
            ...
            this.buy || (this.buy = {
                sp: 1
            }), this.rate ? this.rate.base || (this.rate.base = .5) : this.rate = new n.a(.5, "rate"), this.max || (this.max = new n.a(5, "max", !0))
        }
        canBuy(t) {
    ...
    kongregateAPI.loadAPI((function() {
        window.kong = kongregateAPI.getAPI(), console.warn("KONGREGATE API LOADED")
    })), s.a.mixin({
        components: {
            confirm: _t
        },
